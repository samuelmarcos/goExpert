...
func (ec *executionContext) fieldContext_Query___schema(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "description":
				return ec.fieldContext___Schema_description(ctx, field, obj)
			case "types":
				return ec.fieldContext___Schema_types(ctx, field, obj)
			case "queryType":
				return ec.fieldContext___Schema_queryType(ctx, field, obj)
			case "mutationType":
				return ec.fieldContext___Schema_mutationType(ctx, field, obj)
			case "subscriptionType":
				return ec.fieldContext___Schema_subscriptionType(ctx, field, obj)
			case "directives":
				return ec.fieldContext___Schema_directives(ctx, field, obj)
			}
