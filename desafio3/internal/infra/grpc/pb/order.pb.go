...
func (x *OrderMessage) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *OrderMessage) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *OrderMessage) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x10.pb.OrderMessageR\x06orders2\x8b\x01\n" +
	"\fOrderService\x12>\n" +
